...
export default async function EditGalleryContentPage() {
  const { content, error } = await getPageContent();

  if (error || !content?.gallery) {
    return (
  ...
  return (
    <div>
        ...
        <div className="flex items-center justify-between mb-6">
            <h1 className="text-2xl font-bold font-headline">Rediger "Galleri" side</h1>
        </div>

        <EditGalleryForm content={content.gallery} />
    </div>
  );
}
