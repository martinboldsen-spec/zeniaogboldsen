...
export default async function EditContactContentPage() {
  ...
  return (
    <div>
        ...
        <div className="flex items-center justify-between mb-6">
            <h1 className="text-2xl font-bold font-headline">Rediger "Kontakt" side</h1>
        </div>

        <EditContactForm content={content.contact} />
    </div>
  );
}
